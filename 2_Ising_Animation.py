...
# Parámetros
# ========================================
file_in = "C:/Users/Usuario/Desktop/UGR/COMPU/Kawasaki/resultados/gif_N16_T05_4.txt" # Nombre del fichero de datos
file_out = "animacion" # Nombre del fichero de salida (sin extensión)
interval = 0.0001 # Tiempo entre fotogramas en milisegundos
